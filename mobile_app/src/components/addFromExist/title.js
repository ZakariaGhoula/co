...
class Title extends React.Component {
    ...
    handleClick(event) {
        ...
        if (this.state.title.trim().length == 0) {
            ...
            if (this.state.title.trim().length > 2) {
                ...
                data['id_recepie'] = this.props.old_id_recipe;

                if (this.props.token != null && this.props.processing_recepie == null)
                    this.props.actions_recipe.addRecipeExistTitle(this.props.token, data);
    ...
    componentWillUpdate(nextProps, nextState) {
        ...
        if (nextState.connexionPress && nextProps.processing_recepie != null && nextProps.processing_recepie.title !== "undefined" && nextProps.processing_recepie.title.trim() == nextState.title.trim()) {
            this.props.handleTitle(nextState.title);
...
///
    ...
    this.handleClick.bind(this)
                ...
                {!this.props.isRequesting && <TouchableHighlight
