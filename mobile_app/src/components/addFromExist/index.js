...
class AddRecipeExist extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            to_show: 1,
            to_show_total: 4,
            nbr_recipes :(this.props.my_recipes==null)?0:Object.keys(this.props.my_recipes).length
        }
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (this.state.to_show !== nextState.to_show
            ...
            || this.state.nbr_recipes !== nextState.nbr_recipes
...
//bg-tapis-gris.png
        ...
        if (this.state.to_show == 1  ) {
            data_to_show = <Title handleTitle={this.handleTitle.bind(this)}
                                  old_id_recipe ={this.props.recepie.id_recipe}
