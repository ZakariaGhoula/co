...
export default class ShowFollower extends React.Component {
    ...
    render() {
        ...
        var styles = StyleSheet.create({
            ...
            nbr: {
                fontFamily: 'GuardiLTStd-BlackItalic', fontSize: 13, textAlign: "center",backgroundColor:"transparent"
            }, label: {
                fontFamily: 'OratorStd', fontSize: 11, textAlign: "center",backgroundColor:"transparent"
            },
