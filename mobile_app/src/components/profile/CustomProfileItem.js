...
export default class CustomProfileItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {}
    ...
    handlePress() {
        if (this.props.disconnect) {
            ...
            if(this.props.action2=="recipephotodelete"){

                this.props.actionFired(this.props.source);
            }else{

            }     this.props.actionFired();
