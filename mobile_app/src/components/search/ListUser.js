...
export default class ListUser extends React.Component {
    ...
    render() {
        ...
        var to_show = null;
        if (this.props.list_user == null || this.props.list_user.length==0) {
            to_show = <View
                style={{flex:1,alignItems:"center",padding:padding}}
            ><Text style={styles.block_title}>Aucun utilisateur trouvé</Text></View>
            ...
            to_show = <View
                ...
                {this.props.list_user.map(function (user, index) {

                    return (<Profils key={index} user={user}/>)
                }, this)}</View>;
        }
