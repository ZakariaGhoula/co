...
class Tags extends React.Component {
    ...
    componentWillUpdate(nextProps, nextState) {
        if (nextState.connexionPress && !nextProps.isRequesting && nextProps.processing_recepie != null && nextProps.processing_recepie.tags !== "undefined") {

            this.setState({connexionPress: false})
            this.props.handleTags(nextProps.listTagsSelected);
        }
//
    }
    ...
    handleClick(event) {
        ...
        if (this.state.listTagsSelected.length == 0) {
            ...
            data['list_tags'] = list_final_tag;
            data['id_recepie'] = this.props.processing_recepie.id_recipe;
            if (this.props.token != null) {
                this.props.actions_recipe.updateRecipeTAGS(this.props.token, data);
            }
            ...
            <View style={[styles.bg]}>
                {tags_suggest_list !== null && <View>
                    ...
                    <View style={{flex:1,flexDirection:"row",paddingTop:20, }}>
                        ...
                        <View style={{flex:0.3}}><Text style={{fontSize:12*(width/320),fontFamily: 'Guardi-Roman'}}>Vos
                            tags
                            :</Text></View>
                        <View style={{flex:0.7}}>
                    ...
                    <View style={{flex:1,marginTop:padding,width:width,flexDirection:"row",alignItems:"center"}}>
                        ...
                        <Text
                            style={{color:(this.state.textToShow != null)?"#c41e26":"#000",fontSize:11*(width/320), marginRight:7,fontFamily: 'Guardi-Roman'}}>Ajouter
                    ...
                    <View
                        style={[styles.viewInput,{marginTop:0,marginBottom:0,paddingBottom:0,  borderBottomWidth: 0}]}>
