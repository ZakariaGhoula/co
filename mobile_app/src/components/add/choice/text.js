...
class TextOption extends React.Component {
    ...
    componentWillUpdate(nextProps, nextState) {
        if (nextState.connexionPress && nextProps.processing_recepie != null
            ...
            && (nextProps.processing_recepie.content == nextState.preparation
            || nextProps.processing_recepie.ingredient == nextState.ingredient )
        ) {
            this.props.handleText(nextState.preparation, nextState.ingredient);
