...
class NotificationsNewsApp extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            notification: false,
    ...
    componentWillMount(){
        this.setState({
            notification: (this.props.user.notification.app==1)
        });
    }
    ...
    updateValue(event) {
        ...
        if (this.props.token != null) {
            ...
            this.props.actions.saveUserNotificationApp(this.props.token, notification);
        }
    }
                ...
                <View key={1} style={styles.link}>
                    <View style={styles.linkView}>
                        <View style={styles.TextView}>
                            <Text style={styles.text}>être notifié des actualités {"\n"} de l'application CookOut</Text>
                        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(NotificationsNewsApp);
