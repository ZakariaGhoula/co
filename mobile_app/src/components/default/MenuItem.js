...
export default class MenuItem extends React.Component {
    ...
    handlePress() {
        if (this.props.disconnect) {
            ...
            if (this.props.action == "addrecipe") {
                Actions.addrecipe();
            }
            else if (this.props.action == "myprofile") {
                Actions.myprofile();
            }else if (this.props.action == "myrecipes") {
                Actions.myrecipes();
            }else if (this.props.action == "mynetwork") {
                Actions.mynetwork();
            }
            ...
            else if (this.props.action == "settingmenu") {
                Actions.settingmenu();
            }
        }
    }
    ...
    render() {
        ...
        return (
            <View style={{flex:1}}>
                ...
                <TouchableHighlight  underlayColor='#fff' style={styles.link} onPress={this.handlePress.bind(this)}>
